...
namespace Service
{
    public class TokenService : ITokenService
    {
        ...
        {
            _config = config;
            _key = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_config["Jwt:Key"] ?? "VerySecretKeyForDevelopmentPurposesOnly"));
        }
        ...
        public ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            var tokenValidationParameters = new TokenValidationParameters
            {
                ...
                ValidateLifetime = false // Important: we are getting claims from an expired token
            };
